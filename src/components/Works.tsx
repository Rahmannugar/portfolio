    ...
    <div className="px-5 md:px-10 mt-10">
      <div>
        <motion.h1
          ...
          className="text-3xl cursor-pointer 2xl:text-5xl text-gray-300 font-bold"
        >
        ...
        <div className="mt-16 grid gap-10 sm:gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          ...
          <motion.div
            ...
            className="max-w-[767px] rounded-md px-5 h-[450px] bg-gray-700 py-7 flex flex-col items-center space-y-7"
          >
            <div className="space-y-3">
              ...
              <motion.img
                ...
                alt="bloom-media"
                className="w-[73px] h-[73px] mx-auto"
              />
            </div>
          ...
          <motion.div
            ...
            transition={{ duration: 1, ease: "easeIn" }}
            whileHover={{ scale: 0.8 }}
            className="max-w-[767px] cursor-pointer rounded-md px-5 h-[450px] bg-gray-700 py-7 flex flex-col items-center space-y-7"
          >
            <div className="space-y-3">
              <h1 className="text-xl font-bold text-blue-200">
                FULLSTACK WEB DEVELOPER
            ...
            <div className="space-y-2">
              ...
              <p className="text-justify text-sm">
                ...
                components for cryptocurrency-related applications. I
                implemented features, ensured system functionality, and
                collaborated with cross-functional teams to enhance the overall
                performance of web-based tools in the crypto domain.
              </p>
            </div>
          </motion.div>
          {/* Software Engineer */}
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <p className="text-justify text-sm">
                ...
                Technology, Lagos State, my responsibilities included assisting
                in the development and maintenance of software solutions,
